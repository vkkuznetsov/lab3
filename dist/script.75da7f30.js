...
},{"process":"../node_modules/process/browser.js"}],"../data/data.json":[function(require,module,exports) {
module.exports = {
  "cards": [{
    "name": "Карточка №1",
    "text": "Интересный текст",
    "image_class": "image_1",
    "id": "1"
  }, {
    "name": "Карточка №2",
    "text": "Тоже информативно",
    "image_class": "image_2",
    "id": "2"
  }, {
    "name": "Карточка №3",
...
var tmp = _interopRequireWildcard(require("../data/data.json"));
...
save.addEventListener('click', function () {
  ...
  } else if (!isNaN(parseInt(name[0]))) alert("Название карточки не может начинаться с цифры!");else if (name == "" || text == "" || selector.selectedIndex == 0) alert("Все поля должны быть заполнены!");
});
},{"jquery":"../node_modules/jquery/dist/jquery.js","../data/data.json":"../data/data.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
